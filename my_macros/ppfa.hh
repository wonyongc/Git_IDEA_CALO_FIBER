...
std::pair<std::vector<PseudoJet>,std::vector<PseudoJet> > RunProtoPFA(std::vector<PseudoJet> chargedTracks, std::vector<std::pair<PseudoJet, PseudoJet>> hitsForJet,
                                    ...
                                    TH1F* check1Histo1D, TH1F* check2Histo1D, TH1F *check3Histo1D, TH1F *check4Histo1D, TH1F *check5Histo1D, TH1F *check6Histo1D);
...
(std::vector<PseudoJet> chargedTracks, std::vector<std::pair<PseudoJet, PseudoJet>> allEcalHits, float Bfield, float maxDeltaRSeedEcal,
